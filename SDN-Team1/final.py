...
print " "
print "######################################"
print "# Test security policy BEFORE....... #"
print "######################################"
print " "
CLI( net )
#
...
print " "
print '%s requested application is now provisioned!' % customer
print " "
print "#####################################"
print "# Test security policy AFTER....... #"
print "#####################################"
print " "
CLI( net )

a = raw_input ("Hit Enter to cleanup virtual environment.")
os.system('clear')
